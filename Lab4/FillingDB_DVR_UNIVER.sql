...
------Создание и заполнение таблицы PROFESSION
 ...
 insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION)  values    ('ТТЛП',  '1-46 01 01',      'Лесоинженерное дело', 'ин-женер-технолог' );
 ...
 insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION)  values    ('ТОВ',  '1-48 01 05',    'Химическая технология пере-работки древесины', 'инженер-химик-технолог' ); 
